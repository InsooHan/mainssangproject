...
<br><br>
<p style="font-size: 2.5em; color: #252451; font-weight: 700;">기타
<p>CGV의 주요한 이슈 및 여러가지 소식들을 확인하실 수 있습니다.</p>
<div class="searcharea" style="width:100%; ">
	<!-- 검색창 -->
	<form action="other" class="form-inline">
...
<!-- 카테고리 메뉴 -->
	  <ul class="nav nav-tabs" role="tablist" style="text-align: center;">
	    ...
	    <li class="nav-item" style="width: 120px">
	      <button style="width: 100%"  class="nav-link active " data-bs-toggle="tab" onclick="location.href='other'">기타</button>
	    </li>
	  </ul>
	...
	<c:if test="${totalCount>0 }">
		<div style="width: 800px; text-align:center;"  class="container d-flex justify-content-center">
			...
			<li>
				...
				href="other?currentPage=${startPage-1 }">이전</a>
			</li>
			</c:if>
			<c:forEach var="pp" begin="${startPage }" end="${endPage }"> 
				<c:if test="${currentPage==pp }">
					<li class="active">
						...
						href="other?currentPage=${pp }">${pp }</a>
					</li>
				</c:if>
			...
			<li>
				<a class="container p-1 my-5 border" 
				href="other?currentPage=${endPage+1 }">다음</a>
			</li>
			</c:if>
