					...
					<div class="story-box">
						...
						<div class="story-my" style="margin-bottom: 30px;">
							<c:if test="${sessionScope.loginok!=null&&sessionScope.myid==a.myid }">
								...
								<%-- <span class='rvmod' style="cursor: pointer; font-size: 15px;" idx=${a.idx }><i class="fa-regular fa-pen-to-square"></i></span> --%>
					...
					<div class="story-box">
						...
						<div class="story-my" style="margin-bottom: 30px;">
							<c:if test="${sessionScope.loginok!=null&&sessionScope.myid==a.myid }">
								...
								<span class='rvmod' style="cursor: pointer; font-size: 15px;" idx=${a.idx } rvgrade=${a.grade } rvcontent=${a.content }><i class="fa-regular fa-pen-to-square"></i></span>
								<span class='rvdel' style="cursor: pointer; font-size: 15px;" idx=${a.idx }><i class="fa-sharp fa-solid fa-trash"></i></span>
								<br>
							</c:if>
						</div>
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
				  	<form action="rvupdate" method="post" class="form-inline">
						<input type="hidden" name="num" value="${dto.num }">
						<input type="hidden" name="num" value="${rvdto.idx }">
						<input type="hidden" name="name" value="${rvname }">
						<input type="hidden" name="myid" value="${rvmyid }">
						
				        <div style="border: 1px solid #d8d9db; border-radius: 10px;">
				        	&nbsp;&nbsp;&nbsp;평점&nbsp;
				        	<input type="number" name="grade" id="modgrade" class="form-control" required="required" min="1" max="10" value="${rvgrade }">
							<input type="text" name="content" id="modcontent" class="form-control" required="required" style="width: 715px; height: 90px; border: 0;" value="${rvdto.content }">
							<button type="submit" class="rev btn" style="height: 60px;"><i class="fa-solid fa-pen"></i> 관람평수정</button>
				        </div>
				  	</form>
			      </div>
...
<script type="text/javascript">
	...
	function modfunc(idx) {
		console.log(idx)
		console.log(rvgrade)
 		var g = $(".rgrade").val(${rvdto.grade});
		var c = $(".rcontent").val(${rvdto.content});
 		$("#modgrade").val(g);
 		$("#modcontent").val(c);
		$("#myModal").modal();
	}
